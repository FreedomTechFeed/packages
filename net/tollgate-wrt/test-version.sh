...
# cli.Version="$(PKG_SOURCE_TAG)-g$(short SHA)" (i.e. "v0.6.0-alpha4-g33186bb";
...
# the binary reports the SOURCE version ("v0.6.0-alpha4-g33186bb"), which is
# not the apk package version ("0.6.0_alpha4_pre18-r1").
PKG_VERSION="0.6.0_alpha4_pre18"
...
if OUTPUT_MATCH=$(printf '%s\n' "$OUTPUT" | grep -i "0\.6\.0"); then
